...
"""
Configuration for NBA ML prediction models
"""
from pathlib import Path

# Base directory
BASE_DIR = Path(__file__).parent.parent.parent
MODELS_DIR = BASE_DIR / 'models' / 'nba' / 'saved_models'
...
STAT_KEYS_MAPPING = {
    ...
    'blocks': 'blocks',
    'turnovers': 'turnovers',
    'double_double': 'double_double',  # Calculated: 1 if (points>=10 and rebounds>=10) or (points>=10 and assists>=10) or (rebounds>=10 and assists>=10)
    'fg_made': 'fg_made',
    'ft_made': 'ft_made'
}
...
TRAINING_CONFIG = {
    'test_size': 0.2,
    'min_games_required': 10,  # Minimum games for a player to be included
    'cv_folds': 5,
    'random_state': 42
}
...
VALUE_BET_CONFIG = {
    ...
    'min_edge_for_recommendation': 1.0  # Minimum edge (prediction - line) for recommendation
}
